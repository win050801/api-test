...
def generate_content(content, model_name):
    ...
    try:
        ...
        {content}
        ---
        Dựa trên kịch bản trên, hãy trình bày nội dung bằng tiếng Việt(Không thêm bất cứ ngôn ngữ nào khác) theo đúng cấu trúc sau thêm vào những từ ngữ SEO tìm kiểm để tăng khả năng tiếp cận người xem:
